...
export class StatisticOrderComponent extends PagedListingComponentBase<any> implements OnInit {
  ...
  loadData() {
    ...
    switch(this.currentReport) {
      case 1: {
        apiCall = this._statisticService.getReportAllTime();
        break;
      }
      ...
      case 2: {
        ...
        apiCall = this._statisticService.getReportByMonth(year, month);
        break;
      }

      case 3: {
        apiCall = this._statisticService.getReportByYear(this.year);
        break;
      }
    }
