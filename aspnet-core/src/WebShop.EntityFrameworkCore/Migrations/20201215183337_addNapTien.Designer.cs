...
namespace WebShop.Migrations
{
    ...
    [Migration("20201215183337_addNapTien")]
    partial class addNapTien
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShop.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebShop.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebShop.Domain.Auction.Auction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("HasMakeInvoice")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<decimal>("MinAcceptPrice")
                        .HasColumnType("decimal(65,30)");

                    b.Property<long>("NumberOfBid")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebShop.Domain.Bid.Bid", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebShop.Domain.Invoice.Invoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ReceiperName")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("WebShop.Product.ProductCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WebShop.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WebShop.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WebShop.Authorization.Roles.Role", b =>
                {
                    b.HasOne("WebShop.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("WebShop.Authorization.Users.User", "DeleterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WebShop.Domain.Auction.Auction", b =>
                {
                    ...
                    b.HasOne("WebShop.Authorization.Users.User", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("WebShop.Domain.Bid.Bid", b =>
                {
                    b.HasOne("WebShop.Domain.Auction.Auction", "Auction")
                        .WithMany()
            ...
            modelBuilder.Entity("WebShop.Domain.Invoice.Invoice", b =>
                {
                    ...
                    b.HasOne("WebShop.Domain.Bid.Bid", "Bid")
                        .WithMany()
                        .HasForeignKey("BidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebShop.Product.ProductCategory", b =>
                {
                    b.HasOne("WebShop.Category.Category", "Category")
