...
{
    public abstract class WebShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WebShopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WebShopWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<WebShopDbContext> action)
        {
            using (var context = IocManager.Resolve<WebShopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<WebShopDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<WebShopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WebShopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WebShopDbContext, Task<T>> func)
        {
            T result;
