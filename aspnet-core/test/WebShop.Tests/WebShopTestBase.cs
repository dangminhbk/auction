...
{
    public abstract class WebShopTestBase : AbpIntegratedTestBase<WebShopTestModule>
    {
        protected WebShopTestBase()
        {
            void NormalizeDbContext(WebShopDbContext context)
            {
        ...
        protected Task UsingDbContextAsync(Func<WebShopDbContext, Task> action)
        {
        ...
        protected Task<T> UsingDbContextAsync<T>(Func<WebShopDbContext, Task<T>> func)
        {
